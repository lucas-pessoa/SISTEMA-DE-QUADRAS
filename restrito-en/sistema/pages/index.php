                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-3">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <p class="text-justify">Para confirmar a reserva o usuário deverá clicar no botão de reservar. Caso a quadra desejada esteja disponível naquele horário, após a confirmação, a ação será processada com sucesso.</p>
                                    </div>
                                </div>
                            </div>
