                                    ...
                                    <div id="baseTabela" class="col-md-12">
                                        ...
                                        <div class="col-md-8 text-center">
                                            <div id="botoes">
                                                ...
                                                <button type="button" class="btn btn-success btn-lg" id="botao1" style="margin:3px" value="Futebol">Futebol</button>

                                                <button type="button" class="btn btn-primary btn-lg" id="botao2" style="margin:3px" value="Volei">Volei</button>

                                                <button type="button" class="btn btn-warning btn-lg" id="botao3" style="margin:3px" value="Tenis">Tenis</button>

                                                <button type="button" class="btn btn-danger btn-lg" id="botao4" style="margin:3px" value="Basquete">Basquete</button>
                                            </div>
