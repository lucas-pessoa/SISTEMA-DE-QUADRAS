jQuery("#simulation")
  .on("click", ".s-d014ca1c-b959-4de4-8696-3192d8132c30 .click", function(event, data) {
  ...
  .on("keydown.jim", ".s-d014ca1c-b959-4de4-8696-3192d8132c30 .keydown", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-d014ca1c-b959-4de4-8696-3192d8132c30 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-d014ca1c-b959-4de4-8696-3192d8132c30 #s-Input_5": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d014ca1c-b959-4de4-8696-3192d8132c30 #s-Input_6": {
                      "attributes": {
                        "border-top-width": "1px",
                        "border-top-style": "solid",
                        "border-top-color": "#0088CC",
  ...
  .on("focusout", ".s-d014ca1c-b959-4de4-8696-3192d8132c30 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-d014ca1c-b959-4de4-8696-3192d8132c30 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d014ca1c-b959-4de4-8696-3192d8132c30 #s-Button_7": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-d014ca1c-b959-4de4-8696-3192d8132c30 #s-Button_8": {
                      "attributes": {
  ...
  .on("mouseleave dragleave", ".s-d014ca1c-b959-4de4-8696-3192d8132c30 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
