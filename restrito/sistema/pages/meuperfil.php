                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form method="post" action="meuperfil/atualizadados.php">
                                            ...
                                            <div class="form-group">
                                                <label>Curso</label>
                                                <input class="form-control" placeholder="Insira seu curso" value="<?php echo $_SESSION['curso'];?>" disabled>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form method="post" action="meuperfil/atualizasenha.php">
                                            <div class="form-group">
                                                <label>R.A.</label>
                                                <input class="form-control" placeholder="Insira seu R.A." value="<?php echo $_SESSION['RA'];?>" disabled>
                                            </div>
                                            <div class="form-group">
