            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" data-toggle="modal" data-target="#mConstrucao"><i class="fa fa-sign-out fa-fw"></i> Encerrar sessão</a>
                        </li>  
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body">
                        <p class="lead">Olá <strong>'nome'</strong>! Seja bem vindo ao Sistema de Reservas de Quadras da UFSCar.</p>
                                <!-- <p>
